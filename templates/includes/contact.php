...
<div>
    ...
    <p><strong>Location:</strong> templates/includes/contact.php</p>
    <hr>
    <h3>Demo Contact Details:</h3>
    <ul>
        <li><strong>Email:</strong> demo@example.com (fake)</li>
        <li><strong>Phone:</strong> +1-555-0123 (fake)</li>
        <li><strong>Address:</strong> 123 Demo Street, Demo City (fake)</li>
    </ul>
